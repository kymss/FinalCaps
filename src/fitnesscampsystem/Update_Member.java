...
public class Update_Member extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(UPDATE);
        UPDATE.setBounds(310, 590, 170, 30);
        ...
        jLabel2.setBackground(new java.awt.Color(48, 173, 95));
    ...
    private void UPDATEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEActionPerformed
        ...
        String sql = "UPDATE Members_Tbl SET Firstname=?,Lastname= ?, Sex = ?, ContactNumber=?, Occupation= ?, Address = ?,Hobbies = ?, Contactperson= ?, ContactPersonNo=?, Relationship=?, Healthconcern= ?,"
                + " Currentweight= ?, Targetweight= ?, Month= ? WHERE Firstname=? ";
        try {
//            con = Database.ConnectDB();
            ...
            pst.setString(15, setFirstname);
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "UPDATED!");
            Members cls = new Members();
            cls.Table_view();
//             Table_view();
            pst.close();
            rs.close();
